...
<html>
    ...
    <body  onload="getalltipdoc(), getalltipest()">
                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    <ul class="navbar-nav">
                        <li class="nav-item active">
                            <a class="nav-link" href="menu03.php"><i class="fa fa-home" aria-hidden="true"></i> Home <span class="sr-only">(current)</span></a>
                        </li>                        
                    </ul>
                </div>
                ...
                <div class="col-sm">
                        <table class="table table-striped">
                            ...
                            <nav class="navbar navbar-dark bg-primary">
                                <a class="navbar-brand" href="#"><h4>Registro de cuentas bancarias</h4></a>
                            </nav>                                
                                                                        ...
                                                                        <form class="md-float-material form-material">
                                                                            <div class="">
                                                                                <div class="card-block">
                                                                                    ...
                                                                                    <input type="hidden" name="id_cuenta" id="id_cuenta" class="form-control">
                                                                                            ...
                                                                                            <div class="row m-b-20">
                                                                                                <div class="col-md-12">
                                                                                                    <div class="form-group form-primary">
                                                                                                      <input type="text" name="numcuenta" id="numcuenta" class="form-control border border-primary" disabled>
                                                                                    ...
                                                                                    <div class="row m-b-20">
                                                                                        ...
                                                                                        <div class="col-md-6">
                                                                                                    <div class="form-group form-primary">
                                                                                                        <select class="custom-select custom-select-lg mb-1 border border-primary" id="tipdoc" name="tipdoc">
                                                                                                            <option value=""></option>
                                                                                                        </select>
                                                                                                        <B><FONT COLOR="red">*</FONT></B>                                                                                                        
                                                                                    ...
                                                                                    <div class="row m-b-20">
                                                                                        ...
                                                                                        <div class="col-md-6">
                                                                                            <div class="row m-b-20">
                                                                                                <div class="col-md-12">
                                                                                                    <div class="form-group form-primary">
                                                                                                        <input type="text" name="nombre" id="nombre" class="form-control border border-primary">
                                                                                                        <span class="form-bar"></span>
                                                                                                        <B><FONT COLOR="red">*</FONT></B>                                                                                                        
                                                                                        ...
                                                                                        <div class="col-md-6">
                                                                                            <div class="row m-b-20">
                                                                                                <div class="col-md-12">
                                                                                                    <div class="form-group form-primary">
                                                                                                        <input type="text" name="apellido" id="apellido" class="form-control border border-primary">
                                                                                                        <span class="form-bar"></span>
                                                                                                        <B><FONT COLOR="red">*</FONT></B>                                                                                                        
                                                                                    ...
                                                                                    <div class="row m-b-20">
                                                                                        ...
                                                                                        <div class="col-md-6">
                                                                                            <div class="row m-b-20">
                                                                                                <div class="col-md-12">
                                                                                                    <div class="form-group form-primary">
                                                                                                        <input type="number" name="valape" id="valape" class="form-control border border-primary">
                                                                                                        <span class="form-bar"></span>
                                                                                                        <B><FONT COLOR="red">*</FONT></B>                                                                                                        
                                                                                        ...
                                                                                        <div class="col-md-6">
                                                                                            <div class="row m-b-20">
                                                                                                <div class="col-md-12">
                                                                                                    <div class="form-group form-primary">
                                                                                                        <input type="number" name="valsal" id="valsal" class="form-control border border-primary">
                                                                                                        <span class="form-bar"></span>
                                                                                                        <B><FONT COLOR="red">*</FONT></B>                                                                                                        
                                                                                    ...
                                                                                    <div class="row m-b-20">
                                                                                        ...
                                                                                        <div class="col-md-6">
                                                                                                    <div class="form-group form-primary">
                                                                                                        <select class="custom-select custom-select-lg mb-1 border border-primary" id="tipest" name="tipest">
                                                                                                            <option value=""></option>
                                                                                                        </select>
                                                                                                        <B><FONT COLOR="red">*</FONT></B>                                                                                                        
...
<script type="text/javascript">
    ...
    function getUsuarios(){
        ...
        let get01data = {
          ...
          tipdoc: document.getElementById("tipdoc").value,
          numdoc: document.getElementById("numdoc").value,
          nombre: document.getElementById("nombre").value,
          apellido: document.getElementById("apellido").value,
          valape: document.getElementById("valape").value,
          valsal: document.getElementById("valsal").value,
          tipest: document.getElementById("tipest").value,
        ...
        axios({
          method:'POST',
          url: 'http://localhost:8000/api/cuentasall',
          data: get01data
        })
          .then(function(res) {
             if(res.status==200) {
...
//  	alert ("hola")
  ...
  function getalltipdoc(){
    //alert(tokenr)
    nombreruta = ""
//  	alert ("hola")
        axios({
          method:'GET',
          url: 'http://localhost:8000/api/tipdoc',
        })
          .then(function(res) {
                if(res.status==200 || res.status==201) {
  ...
  function llenarselectTipdoc(){
 
    for(let i = 0; i<get01.length; i++){
      document.querySelector('#tipdoc').innerHTML +=
      `<option value="${get01[i].tipdoc}">
      ${get01[i].nombre}
        </option>`
  ...
  function getalltipest(){
    //alert(tokenr)
    nombreruta = ""
//  	alert ("hola")
        axios({
          method:'GET',
          url: 'http://localhost:8000/api/tipest',
        })
          .then(function(res) {
                if(res.status==200 || res.status==201) {
  ...
  function llenarselectTipest(){
 
    for(let i = 0; i<get01.length; i++){
      document.querySelector('#tipest').innerHTML +=
      `<option value="${get01[i].tipest}">
      ${get01[i].nombre}
        </option>`
...
//          alert("hola2")
	      ...
	      document.getElementById("id_cuenta").value = get01.id,
        document.getElementById("numcuenta").value = get01.id,
        document.getElementById("tipdoc").value = get01.tipdoc,
        document.getElementById("numdoc").value = get01.numdoc,
        document.getElementById("nombre").value = get01.nombre,
        document.getElementById("apellido").value = get01.apellido,
        document.getElementById("valape").value = get01.valape,
        document.getElementById("valsal").value = get01.valsal,
        document.getElementById("tipest").value = get01.tipest,
...
function patUsuario(){
  ...
  id_cuenta = document.getElementById("id_cuenta").value;

  let pat01data = {

          id: document.getElementById("id_cuenta").value,
          tipdoc: document.getElementById("tipdoc").value,
          numdoc: document.getElementById("numdoc").value,
          nombre: document.getElementById("nombre").value,
          apellido: document.getElementById("apellido").value,
      ...
      axios({
        method:'patch',
        url: 'http://localhost:8000/api/cuentas01/'+`${id_cuenta}`,
        data: pat01data
      })
        .then(function(res) {
              if(res.status==200 || res.status==201) {
...
function posUsuario(){
  ...
  let pos01data = {
          ...
          apellido: document.getElementById("apellido").value,
          valape: document.getElementById("valape").value,
          valsal: document.getElementById("valape").value,
          tipest: document.getElementById("tipest").value,
      ...
      axios({
        method:'post',
        url: 'http://localhost:8000/api/cuentas',
        data: pos01data
      })
        .then(function(res) {
              if(res.status==200 || res.status==201) {
